      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
                    ...
                    return AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            monthControl.deleteTemplate(widget.schedule); // 일정 삭제 실행
                            Get.back();
                            Get.back();
                          },
                        ),
              ...
              }, icon: const Icon(EvaIcons.trashOutline,color: Colors.redAccent,)):const SizedBox(),
              WidthBox(bigWidth),
              IconButton(
                  onPressed: () {
                    if (outPagePlace != "") {
                  ...
                  icon: const Icon(Icons.check,color: Colors.white,)) //저장 버튼
            ],
          ),
                ...
                children: [
                  ...
                  if (isAllDay == false)
                    ShowDateStartPicker(
                      ...
                      startText: "시작",
                      datePickerStateController: datePickerStateController,
                      datePickerDateOrder:  DatePickerDateOrder.ymd,
                    ),
                  Height(addPageHeight),
                  if (isAllDay == false)
